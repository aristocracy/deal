	...
	<view class="uni-easyinput" :class="{ 'uni-easyinput-error': msg }" :style="boxStyle">
		<view class="uni-easyinput__content" :class="inputContentClass" :style="inputContentStyle">
			...
			<textarea :enableNative="enableNative" v-if="type === 'textarea'" class="uni-easyinput__content-textarea"
				...
				:placeholderStyle="placeholderStyle" :disabled="disabled" :readonly="readonly" placeholder-class="uni-easyinput__placeholder-class"
			...
			<input :enableNative="enableNative" v-else :type="type === 'password' ? 'text' : type"
				...
				placeholder-class="uni-easyinput__placeholder-class" :disabled="disabled" :readonly="readonly" :maxlength="inputMaxlength"
			...
			<input v-else :type="type === 'password' ? 'text' : type" class="uni-easyinput__content-input" :style="inputStyle"
				...
				:placeholderStyle="placeholderStyle" placeholder-class="uni-easyinput__placeholder-class" :disabled="disabled" :readonly="readonly"
...
<script>
	 ...
	 * @property {Boolean}	readonly	是否禁用（默认false）
